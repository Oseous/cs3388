...
public:
  /*
    ...
    args:
      ...
      Light &light:
        A reference to the light to use for rendering the scene.
        Note that only one light is supported in this implementation.
...
private:
  /*
    ...
    args:
      ...
      Light &light:
        A reference to the scene's point light.
        Will be changed to another vector in the
        future to allow multiple light sources.
